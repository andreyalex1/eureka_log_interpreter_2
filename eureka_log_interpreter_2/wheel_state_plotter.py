...
df1 = pd.read_csv('finished_measurements_2/st_commands.csv',names=headers)
df2 = pd.read_csv('finished_measurements_2/st_states.csv',names=headers)
plt.figure(1)
...
df1 = pd.read_csv('finished_measurements_2/pid_commands.csv',names=headers)
df2 = pd.read_csv('finished_measurements_2/pid_states.csv',names=headers)
plt.figure(2)
